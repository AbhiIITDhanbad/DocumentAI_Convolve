...
# Senior Engineer Fix: Ensure security compliance for PyTorch 2.6+
...
class SignStampAgent:
    def __init__(self, checkpoint_path: str, device: str = "cpu"):
        ...
        # Recursive Search for the internal Torch engine
